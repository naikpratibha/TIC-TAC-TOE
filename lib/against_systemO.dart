...
class AgainstSystemO extends StatefulWidget {
  @override
  _AgainstSystemOState createState() => _AgainstSystemOState();
}

class _AgainstSystemOState extends State<AgainstSystemO> {
  bool ohTurn = true;
