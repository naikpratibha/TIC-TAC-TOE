...
class AgainstFriendO extends StatefulWidget {
  @override
  _AgainstFriendOState createState() => _AgainstFriendOState();
}

class _AgainstFriendOState extends State<AgainstFriendO> {
  bool ohTurn = true;
