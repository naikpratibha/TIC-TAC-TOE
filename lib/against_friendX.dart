...
class AgainstFriendX extends StatefulWidget {
  @override
  _AgainstFriendXState createState() => _AgainstFriendXState();
}

class _AgainstFriendXState extends State<AgainstFriendX> {
  bool ohTurn = true;
